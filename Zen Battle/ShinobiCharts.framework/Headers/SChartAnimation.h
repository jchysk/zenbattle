...
/**
 ...
 - For radial chart series, you can specify how the series rotates around the origin during the animation.  See `angleCurve` for more information.
...
/** Returns an animation where the series scales from its lowest point.
 ...
 If a baseline is set on a column, OHLC, or candlestick series, and a custom origin has not been set on the animation, the baseline will be used as the origin instead.
 */
...
/** This curve only applies to radial chart series.  The animation curve describes the transition of the series around its origin.
...
/** This property enables you to set a normalised point of origin along the x axis for the animation.
 ...
 If a value is set for `absoluteOriginX`, this property will be ignored.
 */
...
/** This property enables you to set a normalised point of origin along the y axis for the animation.
 ...
 If a value is set for `absoluteOriginY`, this property will be ignored.
 */
