...
/** 
 SChartLineSeries is a type of `SChartSeries` that uses the data points to construct a line series. The line series consists of a number of points which may or may not be marked, and which are connected by a line with an optional fill (ie: area series) between the line and the chart axis.
