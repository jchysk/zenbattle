...
/** Specifies whether the chart auto-calculates its axis ranges when it reloads its data.  This defaults to `YES`.
 */
...
/** The background color of the _plot area_ where the series are drawn.
 ...
 To set the background color of the whole chart area use `backgroundColor` - also see `canvasAreaBackgroundColor`. Default value is `clearColor`.*/
...
/** When set to `YES` the double-tap gesture is enabled, and its behaviour obeys the `gestureDoubleTapResetsZoom` property.
 ...
 Otherwise, if set to `NO` the chart's double tap gesture recognizer will be disabled. Defaults to `YES`. */
...
/** When set to `YES` the _double-tap_ gesture will reset the zoom level to _default_
 ...
 Otherwise, if set to `NO` the chart will zoom in  a set amount. Defaults to `NO`. */
...
/** When set to `YES` the radial-chart single tap gesture is enabled
 ...
 Otherwise, if set to `NO` the radial chart's tap gesture recognizer will be disabled. Defaults to `YES`. */
@property (nonatomic) BOOL radialTapEnabled;

/** When set to `YES` the radial-chart rotation gesture is enabled
 
 Otherwise, if set to `NO` the radial chart's rotation gesture recognizer will be disabled. Defaults to `YES`.
...
/** When set to `YES`, the chart will load its data on a background thread.  Otherwise, the chart will load its data on the main UI thread.
 ...
 This defaults to `NO`.  If the chart is loading its data asynchronously, it will pop up an activity indicator while the data is loading.  See `loadingIndicator` for more information on this.
