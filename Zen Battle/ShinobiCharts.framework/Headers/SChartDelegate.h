...
/** A notification that we have started panning on a radial series. 
 ...
 @param radial The chart containing the radial series which has started panning.
 @param radialSeries The radial series being panned.
 */
-(void)sChart:(ShinobiChart *)radial radialSeriesDidStartPanning: (SChartRadialSeries *)radialSeries;

/** A notification that a radial series is being panned.
 ...
 @param radial The chart containing the radial series.
 @param radialSeries The radial series being panned.
 */
-(void)sChart:(ShinobiChart *)radial radialSeriesIsPanning: (SChartRadialSeries *)radialSeries;

/** A notification that a panning gesture on a radial series has ended, and the series will begin to decelerate.
 
 @param chart The chart containing the radial series.
 @param radialSeries The radial series which has started to decelerate.
 */
-(void)sChart:(ShinobiChart *)chart radialSeriesWillBeginDecelerating:(SChartRadialSeries *)radialSeries;

/** A notification that a radial series has come to a halt after being panned and released.
 
 @param chart The chart containing the radial series.
 @param radialSeries The radial series which has finished panning.
 */
...
/** A notification that a data point on a radial (pie or donut, etc) chart has changed state to 'selected' from 'deselected' or vice versa.
 ...
 @param dataPoint The data point which was selected or de-selected.
 @param series The chart series which contains the data point.
...
/** Alter a radial label before it is added to the chart.
 ...
 @param chart The chart containing the radial label.
 @param label The radial label being added to the chart.
 @param datapoint The data point on the chart to which the label applies.
 @param index The index of the data point in its radial series.
 @param series The radial series containing the data point.
 */
