...
/** 
 ...
 <code>
 SChartLineSeriesStyle *thirdSelectedLineSeriesStyle = [lineSeriesStyleForSeriesAtIndex: 2 selected: YES];
 SChartColumnSeriesStyle *secondUnselectedColumnSeriesStyle = [columnSeriesStyleForSeriesAtIndex: 2 selected: NO];
 </code>
